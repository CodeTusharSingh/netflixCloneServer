...
app.get('/removeToken', (req, res) => {
  ...
  res.clearCookie('access_token',{ sameSite: 'None', secure: false, expires: new Date(0) });
  res.clearCookie('Finish_token',{ sameSite: 'None', secure: false, expires: new Date(0) });
  res.clearCookie('plan_token',{ sameSite: 'None', secure: false, expires: new Date(0) });
  res.clearCookie('signed_token',{ sameSite: 'None', secure: false, expires: new Date(0) });
